...
class Member {
  ...
  factory Member.fromJson(Map<String, dynamic> json) {
    return Member(
      ...
      office: json['office'] != null ? Office(
        id: _parseString(json['office']['id']),
        title: _parseString(json['office']['title']),
        content: null,
        thumbnail: null,
        location: '',
        leader: OfficeLeader(name: '', title: '', phone: ''),
        leaders: [],
        leadersCount: 0,
        totalMembers: 0,
      ) : null,
      leader: null, // يمكن تعديله إذا كانت البيانات تحتوي على معلومات القائد
    );
  }
}
...
class Representation {
  ...
  factory Representation.fromJson(Map<String, dynamic> json) {
    return Representation(
      ...
      title: _parseString(json['title'], 'بدون عنوان'),
      thumbnail: json['thumbnail']?.toString(),
      leader: RepresentationLeader.fromJson(json),
      location: _parseString(json['location'], 'غير محدد'),
